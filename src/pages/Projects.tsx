...
const projectsData: Project[] = [
  {
    ...
    description: 'A full-featured online shopping platform with payment processing, user authentication, and admin dashboard.',
  ...
  },
  {
    ...
    description: 'Collaborative task tracking application with real-time updates, user assignments and progress tracking.',
  ...
  },
  {
    ...
    description: 'High-performance API service with authentication, rate limiting, and comprehensive documentation.',
  ...
  },
  {
    ...
    description: 'Property listing and search platform with map integration, filters, and user favorite listings.',
  ...
  },
  {
    ...
    description: 'Custom CMS with role-based access control, media management, and publishing workflow.',
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-2">
          {project.tech.map((tech) => (
            <span key={tech} className="bg-purple/10 text-purple px-2 py-1 rounded text-xs">
              {tech}
            </span>
          ))}
        </div>
