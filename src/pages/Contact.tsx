        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-10">
            ...
            <div className="md:col-span-2 space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:john@example.com" className="text-gray-600 dark:text-gray-400 hover:text-purple transition-colors">
                        john@example.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:+11234567890" className="text-gray-600 dark:text-gray-400 hover:text-purple transition-colors">
                        (123) 456-7890
                      </a>
                    </div>
                  </div>
              ...
              <div className="bg-purple text-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold mb-4">Let's Connect</h3>
                <p className="mb-6">
                  Follow me on social media to see my latest projects and updates.
                </p>
                <div className="flex space-x-4">
                  <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="bg-white/20 p-2 rounded-full hover:bg-white/30 transition-colors">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md animate-fade-in">
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <Button type="submit" className="bg-purple hover:bg-purple-light" disabled={isSubmitting}>
                      {isSubmitting ? (
                        <>
